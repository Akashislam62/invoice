                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <span class="text-danger p-0 mb-4 d-none" id="email-error"> * Email is required</span>
                                    <span class="text-danger p-0 mb-4 d-none" id="email-format-error"> * Invalid your email format</span>
                                    <span class="text-danger p-0 mb-4 d-none" id="email-format-unique"> * Email already exits </span>
                                </div>
                            </div>
